...
(defun-g fragment-shader-stage ((colour :vec3)
  ...
  (let* ((uv (vec2 (aref uv 0)
         ...
         (result (vec4 (mix (aref result 0) (aref debug-colour 0) 0.5)
                       (mix (aref result 1) (aref debug-colour 1) 0.5)
                       (mix (aref result 2) (aref debug-colour 2) 0.5)
                       (mix (aref result 3) (aref debug-colour 3) 0.5))
                 ))
    result))
